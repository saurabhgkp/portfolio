...
import type { AddRayMessage, CollideBeginEvent, CollideEndEvent, CollideEvent, Event, VectorName } from './setup';
...
export declare type BodyProps<T = unknown> = Partial<AtomicProps> & Partial<VectorProps> & {
    args?: T;
...
export declare type BodyPropsArgsRequired<T = unknown> = BodyProps<T> & {
    args: T;
};
...
export declare type WorkerApi = AtomicApi & VectorApi & {
...
export declare function useRaycastClosest(options: RayOptions, callback: (e: Event) => void, deps?: DependencyList): void;
export declare function useRaycastAny(options: RayOptions, callback: (e: Event) => void, deps?: DependencyList): void;
export declare function useRaycastAll(options: RayOptions, callback: (e: Event) => void, deps?: DependencyList): void;
