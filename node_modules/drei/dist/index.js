...
import { AudioListener, AudioLoader, HalfFloatType, Vector3, PerspectiveCamera as PerspectiveCamera$1, OrthographicCamera as OrthographicCamera$1, Color, ShaderChunk, Matrix4, Ray, Sphere as Sphere$1, Raycaster, Camera } from 'three';
...
const TransformControls = forwardRef((_ref, ref) => {
  let {
    ...
    showZ
      ...
      props = _objectWithoutPropertiesLoose(_ref, ["children", "enabled", "axis", "mode", "translationSnap", "rotationSnap", "scaleSnap", "space", "size", "dragging", "showX", "showY", "showZ"]);
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("transformControlsImpl", {
    ref: mergeRefs([controls, ref]),
    args: [camera, gl.domElement],
    enabled: enabled,
    axis: axis,
    ...
    rotationSnap: rotationSnap //@ts-ignore
    ,
    scaleSnap: scaleSnap,
    space: space,
    size: size,
...
const HTML = React.forwardRef((_ref, ref) => {
  ...
  const styles = useMemo(() => _extends(_extends({
    position: 'absolute',
...
export { Box, Circle, Cone, Cylinder, Detailed, Dodecahedron, Extrude, HTML, Icosahedron, Lathe, MapControls, Octahedron, OrbitControls, OrthographicCamera, Parametric, PerspectiveCamera, Plane, Polyhedron, PositionalAudio, Ring, Shadow, Sky, Sphere, StandardEffects, Stats, Tetrahedron, Text, Torus, TorusKnot, TrackballControls, TransformControls, Tube, draco, meshBounds, softShadows, useCamera, useHelper };
